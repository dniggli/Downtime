...
namespace downtimeC
{
    public partial class OrderEntryForm : BaseForm
    {
            ...
            : base(StartupTime)
        {
            ...
            specimensDict = new Dictionary<TextBox, SpecimenType>();
            specimensDict.Add(this.comment, SpecimenType.Comment);

            specimensDict.Add(this.redtest, SpecimenType.Red);
            specimensDict.Add(this.bluetest, SpecimenType.Blue);
            specimensDict.Add(this.greentest, SpecimenType.Green);
            specimensDict.Add(this.lavchemtest, SpecimenType.LavChem);
            specimensDict.Add(this.lavhemtest, SpecimenType.LavHem);
            specimensDict.Add(this.graytest, SpecimenType.Gray);
            specimensDict.Add(this.urinechem, SpecimenType.UrineChem);
            specimensDict.Add(this.urinehem, SpecimenType.UrineHem);
            specimensDict.Add(this.bloodgas, SpecimenType.BloodGas);
            specimensDict.Add(this.sendout, SpecimenType.SendOut);
            specimensDict.Add(this.ser, SpecimenType.Ser);
            specimensDict.Add(this.hepp, SpecimenType.Hepp);
            specimensDict.Add(this.csfbox, SpecimenType.Csf);
            specimensDict.Add(this.fluidbox, SpecimenType.Fluid);
            specimensDict.Add(this.Viralloadbox, SpecimenType.Viral);
            specimensDict.Add(this.OTHERBOX, SpecimenType.Other);
            specimensDict.Add(this.TextBoxIMMUNO, SpecimenType.Immuno);
        }
        ...
        {
            DataRow q = mySql.FilledRow("insert into dtdb1.ordernumber (OrderLast,Ordernumber) select OrderLast+1, ordernumber+1 from dtdb1.ordernumber ORDER BY OrderLast DESC LIMIT 1;select OrderLast, Ordernumber from dtdb1.ordernumber ORDER BY OrderLast DESC LIMIT 1;");
        ...
        public void ButtonClick()
        {
            ...
            foreach (KeyValuePair<TextBox, SpecimenType> spec in specimensDict)
            {
                var tests = spec.Key.Text;
                if ((!string.IsNullOrEmpty(tests)))
                {
                    var codes = tests.Split(',');
                    foreach (string code in codes)
                    {
                        var indiCodes = GroupTestToIndividualTest.getIndividualTests(code);
                        sendHL7(this.mrn.Text, this.firstname.Text, this.lastname.Text, this.ordernumber.Text, this.ComboBoxWard.Text, indiCodes, spec.Value);
                    }
                }
            }
