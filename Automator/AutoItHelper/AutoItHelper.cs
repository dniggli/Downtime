...
namespace AutoItHelper
{
    public class AutoItX
    {
        ...
        static AutoItX() {
            ...
            string dirName = Path.Combine(Path.GetTempPath(), "AutoItHelper." +
              Assembly.GetExecutingAssembly().GetName().Version.ToString());
            if (!Directory.Exists(dirName))
                Directory.CreateDirectory(dirName);
            string dllPath = Path.Combine(dirName, "AutoItX3.dll");
            ...
            using (Stream stm = Assembly.GetExecutingAssembly().GetManifestResourceStream(
              "AutoItHelper.Properties.AutoItX3.dll"))
            {
                // Copy the embedded assembly to the temporary file
                try
                {
        ...
        /// </returns>
        ///----------------------------------------------------------------------
        public static bool WinExists(string vsTitle)
        {
            return AU3_WinExists(vsTitle, "") == 1;
        }
        ...
        /// </returns>
        ///----------------------------------------------------------------------
        public static bool WinExists(string vsTitle, string vsText)
        {
            return AU3_WinExists(vsTitle, vsText) == 1;
        }
        ...
        public static int WinWaitClose(string vsTitle)
        {
            return AU3_WinWaitClose(vsTitle, "", 3000);
        }
        ...
        /// </returns>
        ///----------------------------------------------------------------------
        public static bool WinWaitActive(string vsTitle, string vsText, int iTimeout)
        {
            return AU3_WinWaitActive(vsTitle, vsText, iTimeout) == 1;
        }
        ...
        /// </returns>
        ///----------------------------------------------------------------------
        public static bool WinWaitActive(string vsTitle, int iTimeout)
        {
            return AU3_WinWaitActive(vsTitle, "", iTimeout) == 1;
        }
        ...
        /// </returns>
        ///----------------------------------------------------------------------
        public static bool WinWaitActive(string vsTitle)
        {
            return AU3_WinWaitActive(vsTitle, "", 3000) == 1;
        }
