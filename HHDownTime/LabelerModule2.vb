...
Module Labeler1
    ...
    Sub LabelPrint1(ByVal ldata1 As LabelData1, ByVal printer As String)
        ...
        'label += "^FO0040,137,^BC,,N,,,A,^FD" & ldata1.orderNumber & ldata1.extension & "^FS" & vbNewLine
    ...
    Sub LabelPrint3(ByVal ldata1 As LabelData1, ByVal printer As String)
        Dim sTemplatelines As New ArrayList
